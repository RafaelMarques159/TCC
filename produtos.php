            ...
            <div class="row">
                <div class="col-5 col-md-2 mb-3">
                    ...
                    <ul class="nav1 flex-column">
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Meus pedidos</a>
                        </li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Minha Conta</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-6 col-md-2 mb-3">
                    <h5>Departamentos</h5>
                    <ul class="nav1 flex-column">
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Materiais de
                                Construção</a>
                        </li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Material
                                Elétrico</a></li>
                        <li class="nav-ite1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Iluminação</a>
                        </li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Tintas e
                ...
                <div class="col-6 col-md-2 mb-3">
                    <h5>Suporte</h5>
                    <ul class="nav1 flex-column">
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Fale conosco</a>
                        </li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Troca e
                                Devolução</a></li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Políticas de
                                Entrega</a>
                        </li>
                        <li class="nav-item1 mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Sobre</a></li>
                    </ul>
                </div>

                <div class="col-md-5 offset-md-1 mb-3">
                    <h5>Atendimento</h5>
                    <p><strong>Telefone:</strong> (21) 4003-4456</p>
                    <p><strong>Horário do SAC:</strong><br>De segunda à sábado de 8h às 18h</p>
                    <p><strong>Email SAC:</strong><br><a href="mailto:contato@chatuba.com.br">contato@.com.br</a></p>
                    <p><strong>Televendas:</strong><br><a href="mailto:chatuba.televendas@chatuba.com.br"></a></p>
                </div>
            </div>

            <div class="d-flex flex-column flex-sm-row justify-content-center py-2 my-5 border-top">
                <p class="mt-2">&copy; 2025 Company, Inc. All rights reserved.</p>
